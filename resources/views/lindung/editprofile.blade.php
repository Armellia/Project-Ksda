        ...
        <main class="col-md-12 ml-sm-auto col-lg-12 px-md-4 py-4">
              <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="myModal-label" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="card card-primary">
                                ...
                                <!-- form start -->
                                  <div class="card-body">
                                    <form method="post" action="{{route('editprofileperlindungan')}}">
                                      {{ csrf_field() }}
                                        <div class="form-group">
                                          <label for="namaEdit">Nama Perlindungan</label>
                                          <input id="namaEdit" class="form-control" type="text" name="namaPerlindungan">
                                          <input id="idEdit" class="form-control" type="hidden" name="idPerlindungan">
                                        </div>
                                        <div class="form-group">
                                          <label for="alamatEdit">Alamat Perlindungan</label>
                                          <input id="alamatEdit" class="form-control" type="text" name="alamatPerlindungan">
                                        </div>
                                        <div class="form-group">
                                          <label for="notelpEdit">No.Telp Perlindungan</label>
                                          <input id="notelpEdit" class="form-control" type="text" name="noTelpperlindungan">
                                        </div>
                                  </div>
                                  <!-- /.card-body -->
                              </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="card card-primary">
                                    ...
                                    <!-- form start -->
                                      <div class="card-body">
                                        <form method="post" action="{{route('editpasswordperlindungan')}}">
                                          {{ csrf_field() }}
                                            <div class="form-group">
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#editModal" onclick="getProfile({{$perlindungan->id}})">Edit Profile</button>
  ...
  function getProfile(id){
    $.ajax({
              ...
              success: function(data){
                 ...
                 $('#idEdit').val(data['id']);
                  $('#namaEdit').val(data['namaPerlindungan']);
